...
public class ScheduleMapper {
    ...
    public CreatedAppointment scheduleToCreateAppointmentCommandResponse(domain.entity.Schedule schedule) {
        ...
        var scheduleResponse = new Schedule(
                schedule.getId(),
                schedule.getScheduleDate().getStart(),
                schedule.getScheduleDate().getEnd());

        var companyResponse = new Company(
                company.getId(),
        ...
        var employeeResponse = new Employee(
                employee.getId(),
        ...
        return new CreatedAppointment(customerResponse, scheduleResponse, serviceResponse, employeeResponse, companyResponse);
    }
    ...
    public FoundAppointment scheduleToFindAppointmentQueryResponse(domain.entity.Schedule schedule) {
        ...
        return new FoundAppointment(customerResponse, scheduleResponse, serviceResponse, employeeResponse, companyResponse);
    }
    ...
    public FoundAvailableSchedules scheduleToFindAvailableSchedulesQueryResponse(domain.entity.Schedule schedule) {
        ...
        var scheduleResponse = new Schedule(schedule.getId(),
                schedule.getScheduleDate().getStart(),
                schedule.getScheduleDate().getEnd());
        var companyResponse = new Company(company.getId(), company.getCompanyDetails().getName(), company.getCompanyDetails().getGovernmentId());
        ...
        return new FoundAvailableSchedules(scheduleResponse, serviceResponse, employeeResponse, companyResponse);
    }
}