...
public class CompanyMapper {
    ...
    public CreateCompanyResponse companyToCreateCompanyCommandResponse(entity.Company company) {
    ...
    public FindCompanyResponse companyToFindCompanyQueryResponse(entity.Company company) {
